...
export const Login = () => {
  ...
  async function handleLoginGuest(){
    email.current.value = "abhishek@kumar.com";
    password.current.value = "Abhi123";
    try{
      const authDetail = {
        email: email.current.value,
        password: password.current.value
